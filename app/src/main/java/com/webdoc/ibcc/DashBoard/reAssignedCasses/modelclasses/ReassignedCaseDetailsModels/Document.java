...
public class Document {
    ...
    @Expose
    private Object examinationSystem;
    ...
    @Expose
    private Object titleOfQualification;
    @SerializedName("fatherCnic")
    @Expose
    private Object fatherCnic;
    @SerializedName("presentEmploymentOfParents")
    @Expose
    private Object presentEmploymentOfParents;
    @SerializedName("fatherName")
    @Expose
    private Object fatherName;
    @SerializedName("parentsPermanentAddress")
    @Expose
    private Object parentsPermanentAddress;
    @SerializedName("parentsNameOfTheOrganization")
    @Expose
    private Object parentsNameOfTheOrganization;
    @SerializedName("caseUploadedTravellingDocumentResponse")
    @Expose
    private ArrayList<CaseUploadedTravDocumentResponse> caseUploadedTravellingDocumentResponse = null;
    @SerializedName("caseUploadedDocumentResponse")
    @Expose
    private ArrayList<CaseUploadedDocumentResponse> caseUploadedDocumentResponse = null;
    @SerializedName("qualificationSubjectResponse")
    @Expose
    private ArrayList<QualificationSubjectResponse> qualificationSubjectResponse = null;
    @SerializedName("documentDetailList")
    @Expose
    private DocumentDetailList documentDetailList;
    ...
    public Object getExaminationSystem() {
        return examinationSystem;
    }

    public void setExaminationSystem(Object examinationSystem) {
    ...
    public Object getTitleOfQualification() {
        return titleOfQualification;
    }

    public void setTitleOfQualification(Object titleOfQualification) {
        this.titleOfQualification = titleOfQualification;
    }

    public Object getFatherCnic() {
        return fatherCnic;
    }

    public void setFatherCnic(Object fatherCnic) {
        this.fatherCnic = fatherCnic;
    }

    public Object getPresentEmploymentOfParents() {
        return presentEmploymentOfParents;
    }

    public void setPresentEmploymentOfParents(Object presentEmploymentOfParents) {
    ...
    public Object getParentsPermanentAddress() {
        return parentsPermanentAddress;
    }

    public void setParentsPermanentAddress(Object parentsPermanentAddress) {
        this.parentsPermanentAddress = parentsPermanentAddress;
    }

    public Object getParentsNameOfTheOrganization() {
        return parentsNameOfTheOrganization;
    }

    public void setParentsNameOfTheOrganization(Object parentsNameOfTheOrganization) {
        this.parentsNameOfTheOrganization = parentsNameOfTheOrganization;
    }

    public ArrayList<CaseUploadedTravDocumentResponse> getCaseUploadedTravellingDocumentResponse() {
        return caseUploadedTravellingDocumentResponse;
    }

    public void setCaseUploadedTravellingDocumentResponse(ArrayList<CaseUploadedTravDocumentResponse> caseUploadedTravellingDocumentResponse) {
        this.caseUploadedTravellingDocumentResponse = caseUploadedTravellingDocumentResponse;
    }

    public ArrayList<CaseUploadedDocumentResponse> getCaseUploadedDocumentResponse() {
        return caseUploadedDocumentResponse;
    }

    public void setCaseUploadedDocumentResponse(ArrayList<CaseUploadedDocumentResponse> caseUploadedDocumentResponse) {
        this.caseUploadedDocumentResponse = caseUploadedDocumentResponse;
    }

    public ArrayList<QualificationSubjectResponse> getQualificationSubjectResponse() {
        return qualificationSubjectResponse;
    }

    public void setQualificationSubjectResponse(ArrayList<QualificationSubjectResponse> qualificationSubjectResponse) {
        this.qualificationSubjectResponse = qualificationSubjectResponse;
    }

    public DocumentDetailList getDocumentDetailList() {
        return documentDetailList;
    }

    public void setDocumentDetailList(DocumentDetailList documentDetailList) {

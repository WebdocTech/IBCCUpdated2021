...
public class Document_EQ {
    ...
    @Expose
    private List<CaseUploadedTravellingDocumentResponse> caseUploadedTravellingDocumentResponse = null;
    ...
    public List<CaseUploadedTravellingDocumentResponse> getCaseUploadedTravellingDocumentResponse() {
        return caseUploadedTravellingDocumentResponse;
    }

    public void setCaseUploadedTravellingDocumentResponse(List<CaseUploadedTravellingDocumentResponse> caseUploadedTravellingDocumentResponse) {

...
public class GroupAdapter extends ArrayAdapter<EquivalenceGroup> {
    private Activity context;
    List<EquivalenceGroup> data = null;

    public GroupAdapter(Activity context, int resource, List<EquivalenceGroup> data) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        EquivalenceGroup item = data.get(position);

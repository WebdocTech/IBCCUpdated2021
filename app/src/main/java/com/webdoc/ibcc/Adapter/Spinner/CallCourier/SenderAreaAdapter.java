...
public class SenderAreaAdapter extends ArrayAdapter<GetAreasByCity> {
    private Activity context;
    List<GetAreasByCity> data = null;

    public SenderAreaAdapter(Activity context, int resource, List<GetAreasByCity> data) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        GetAreasByCity item = data.get(position);
        String Id = String.valueOf(item.getCityID());
        String Name = item.getAreaName();

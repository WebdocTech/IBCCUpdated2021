package com.webdoc.ibcc.Payment.PaymentMethods.BankAlfalah.BankAlfalahWallet.ViewModel;
...
public class BankAlfalahWalletViewModel extends AndroidViewModel {

    WebView wb;

    //todo:Mutable Live Data
    private final MutableLiveData<String> MLD_open_BankAlfalah_Wallet_Webview = new MutableLiveData<>();
    ...
    public LiveData<String> LD_open_BankAlfalah_Wallet_webview() {
    ...
    //todo:constructor
    public BankAlfalahWalletViewModel(@NonNull Application application) {
        super(application);
    ...
    public void openBankAlfalahWalletWebView(WebView webView, String url) {
        this.wb = webView;
        ...
        wb.setWebViewClient(new BankAlfalahWalletViewModel.MyWebViewClient());
        wb.loadUrl(url);
    ...
    public void CallingSavePaymentApiOnBankAlfalahWalletSuccess(String IBCC_amount, String webdoc_amount, String case_id, String amount_paid, String bank, String account_number, String mobile_number, String transection_type, String transaction_reference_number, String transaction_datetime, String user_id, String bankCharges, String courier_amount, String platform, String transactionReferenceNumber) {

package com.webdoc.ibcc.Payment.PaymentMethods.BankAlfalah.BankAlfalhCreditDebit.ViewModel;
...
public class CreditDebitViewModel extends AndroidViewModel {

    WebView wb;

    //todo: Mutable Live data
    private final MutableLiveData<String> MLD_openCreditdebitWebview = new MutableLiveData<>();
    ...
    public LiveData<String> LD_openCreditDebitWebview() {
    ...
    //todo : constructor
    public CreditDebitViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void openCreditDebitWebview(WebView webview, String url) {
    ...
    public void CallingSavePaymentApiOnBankAlfalahCreditDebitSuccess( String IBCC_amount, String webdoc_amount, String case_id, String amount_paid, String bank, String account_number, String mobile_number, String transection_type, String transaction_reference_number, String transaction_datetime, String user_id, String transactionReferenceNumber, String bankCharges, String courier_amount, String platform) {
